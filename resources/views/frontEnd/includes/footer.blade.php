	...
	<footer>
			...
			<div id="footer-top">
				...
				<div class="company-info">
					<figure class="logo small">
						<img src="{{url('/frontEnd/images/logo-old.png')}}" alt="logo-small">
					</figure>
				...
				<div class="link-info">
					...
					<ul class="link-list">
						<li class="link-item">
							...
							<a href="{{route('howToSell')}}">How To Sell</a>
						</li>
						<li class="link-item">
							<div class="bullet"></div>
							<a href="{{route('howToBuy')}}">How To Buy</a>
						</li>
				...
				<div class="link-info">
					...
					<ul class="link-list">
						<li class="link-item">
							<div class="bullet"></div>
							<a href="{{route('helpSupport')}}">Help Center</a>
						</li>
						<li class="link-item">
							<div class="bullet"></div>
				...
				<div class="company-info" style="width:220px;">
				    <!--<ul class="company-info-list">
						...
						<li class="company-info-item">
							...
							<p><span>1.207.300</span> Customers</p>
						</li>
						<li class="company-info-item">
		...
		<div id="footer-bottom-wrap">
			<div id="footer-bottom">
				<p><span>&copy;</span><a href="index.html">E-bazarr</a> All Rights Reserved 2020</p>
			</div>
		</div>
		<!-- /FOOTER BOTTOM -->
	</footer>
