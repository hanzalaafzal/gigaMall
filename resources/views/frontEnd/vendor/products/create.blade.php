...
<div class="dashboard-content">
    ...
    <!-- PACK BOXES -->
    <form method="post" @if(auth()->user()->permissions_id == 1) action="/admin/storeProduct" @else action="{{route('productStore')}}" @endif id="upload_form" enctype="multipart/form-data">
    {{csrf_field()}}
