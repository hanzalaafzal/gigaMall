...
<a href="{{url('/')}}" class="db-close-button">
   <img src="{{url('/frontEnd/images/dashboard/back-icon.png')}}" alt="back-icon">
</a>
<!-- DB CLOSE BUTTON -->

<!-- DB OPTIONS BUTTON -->
<div class="db-options-button">
   <img src="{{url('/frontEnd/images/dashboard/db-list-right.png')}}" alt="db-list-right">
   <img src="{{url('/frontEnd/images/dashboard/close-icon.png')}}" alt="close-icon">
</div>
<!-- DB OPTIONS BUTTON -->
...
<div class="dashboard-header-item title">
    <!-- DB SIDE MENU HANDLER -->
     <div class="db-side-menu-handler">
        <img src="{{url('/frontEnd/images/dashboard/db-list-left.png')}}" alt="db-list-left">
    </div>
    <!-- /DB SIDE MENU HANDLER -->
...
<div class="dashboard-header-item form">
    <form class="dashboard-search">
        ...
        <input type="image" src="{{url('/frontEnd/images/dashboard/search-icon.png')}}" alt="search-icon">
    </form>
</div>
<!-- /DASHBOARD HEADER ITEM -->
...
<div class="dashboard-header-item stats">
    ...
    <div class="stats-meta">
        {{--  <h6>{{count(Auth::user()->shops)}}</h6>
        <p>Total Number of Shops</p>  --}}
    </div>
    <!-- /STATS META -->
</div>
<!-- /DASHBOARD HEADER ITEM -->
...
<div class="dashboard-header-item stats">
    <!-- STATS META -->
    <div class="stats-meta">
        {{--  <h6>{{count(Auth::user()->products)}}</h6>
