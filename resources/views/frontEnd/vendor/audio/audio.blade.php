...
<div class="dashboard-content">
   ...
   <div class="headline buttons primary">
      ...
      <div class="shops-buttons">
          ...
          <label><h3 style="padding-top:25px;">Audio Conferencing Section</h3></label>
   ...
   <!-- PURCHASES LIST -->
    <div class="purchases-list">
        ...
        <div id="audios-container" style="margin: 20px 0;"></div>
        ...
        <script>
          ...
          document.getElementById('open-or-join-room').onclick = function() {
              ...
              connection.openOrJoin(document.getElementById('room-id').value, function(isRoomExist, roomid) {
                 //removed not operator from following if
                if (isRoomExist) {
                      showRoomURL(roomid);
                  }
              });
          ...
          function showRoomURL(roomid) {
              ...
              var html = '<br><br><br><br><h2>Unique URL for your room:</h2><br>';
              html += 'Hash URL: <a href="' + roomHashURL + '" target="_blank">' + roomHashURL + '</a>';
              html += '<br>';
              html += 'QueryString URL: <a href="' + roomQueryStringURL + '" target="_blank">' + roomQueryStringURL + '</a>';
              html += '<br><br>';
              html+='<button type="button" onclick="myFunction()" class="btn btn-success">Click to copy invitation address for audio conferencing </button>';
              html += '<br><br>';
