...
<div class="dashboard-content">
   ...
   <div class="headline buttons primary">
      ...
      <div class="shops-buttons">
          ...
          <label><h3 style="padding-top:25px;">Video Conferencing Section

            @php
            $theuri=$_SERVER['REQUEST_URI'];
            $room=(explode("?roomid=",$theuri));
            if(isset($room[1])){
           // echo "room id is ";echo $room[1];
            $theRoom=\App\Conference::where('room_number','=',$room[1])->first();
            
           // $theRoom['chat_id']=str_replace("{","",$theRoom['chat_id']);
            //$theRoom['chat_id']=str_replace("}","",$theRoom['chat_id']);
            //echo $theRoom['chat_id'];
            }
           // echo $abc;    
            @endphp
          </h3>
          @if(isset($theRoom['chat_id']))
         ...
         <script>
            setTimeout( function(){ 
             alert("fuction calls");
              ...
              var theValueText=$('#{{ $theRoom['chat_id']}} h2:first').text('This is vendor');
            //alert(insideText);
            }  , 9999);
   ...
   <!-- PURCHASES LIST -->
    <div class="purchases-list">
            ...
            <div class="purchases-list-header-date">
              <script>
                $(document).ready(function(){
                  ...
                  var roomid = pathname.split("?roomid=");
                  //alert(roomid[1]);
                 // alert(pathname); 
                  $("#room-id").hide();
                  $("#myInput").hide();
        ...
        {{-- start video div --}}
        {{-- <div>
           <div class="media-container" id="dtXKanej6kHyBhgPe0KtI5j6VJKt6sH3AZYD" style="width: 369px;"><div class="media-controls" style="margin-left: 330px; opacity: 1;"><div class="control zoom-in"></div></div><div class="volume-control" style="margin-left: 365px; margin-top: 274px; opacity: 1;"></div><div class="media-box"><h2 style="position: absolute;color:white;font-size:17px;text-shadow: 1px 1px black;padding:0;margin:0;text-align: left; margin-top: 10px; margin-left: 10px; display: block; border: 0;line-height:1.5;z-index:1;">42</h2><video autoplay="" playsinline="" muted="" style="max-height: 757px;"></video></div></div>
       </div>  --}}
       {{-- --end divtestvideo-- --}}
      ...
      // connection.socketURL = 'https://68.183.231.251:9001/';        
      //connection.socketURL = 'https://bazaarsy.com:9001/';
       ...
       // alert(document.getElementById("myInput").value);
        ...
        <script>
          function myFunction() {
           ...
           // alert($('.media-container').attr('id'));
            var theidOfDv=$('#videos-container .media-container:first').attr('id');
           // var theValueText=$('#videos-container h2:first').text();
            //alert('unique value is');
            //alert(theValueText);
            //start Ajax call
           var roomedid= document.getElementById("room-id").value;
           var route = 'chat-update/'+theidOfDv+'/'+roomedid;
