  ...
  <div class="padding">
     <div class="box">
        <div class="box-header dker">
           <h3><i class="material-icons"></i> Products Approval List</h3>
           <small>
           <a href="{{url('/admin')}}">Home</a> /
           <a href="">Products Approval List</a>
           </small>
        </div>
        <div class="box-tool">
           <ul class="nav">
                      ...
                      <tbody>
                         @foreach($products as $product)
                          <tr>
                              ...
                              <td class="text-center">
                                <a href="{{route('productApprove',$product->id)}}" class="btn btn-primary btn-sm">@if($product->daily_sale == 1)Approve Daily Sale @else Approve @endif</a>
                                <a href="{{route('productDisable',$product->id)}}" class="btn btn-danger btn-sm">Disable</a>
                              </td>
                          </tr>
                         @endforeach
                      </tbody>
