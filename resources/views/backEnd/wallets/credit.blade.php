...
<div class="padding">
   <div class="box">
      <div class="box-header dker">
         <h3><i class="material-icons"></i> Add Amount to Wallet</h3>
         <small>
      ...
      <div class="box-body">
         <form method="POST" action="{{route('addFromWallet')}}" accept-charset="UTF-8" enctype="multipart/form-data">
            ...
            <div class="form-group row">
               <label for="title_ar" class="col-sm-2 form-control-label">Addition Head</label>
               <div class="col-sm-10">
                  <input placeholder=""  class="form-control has-value" id="price" required="" name="additionHead" type="text" >
               </div>
            </div>
            <div class="form-group row">
               <label for="title_ar" class="col-sm-2 form-control-label">Add in Wallet Amount</label>
               <div class="col-sm-10">
                  <input placeholder=""  class="form-control has-value" id="price" required="" name="additionAmount" type="number" >
